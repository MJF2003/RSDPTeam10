...
python ~/ros2_ws/src/rsdp_perception/rsdp_perception/perception_typed_node.py \
  --ros-args \
  -p weights:=/home/laptop30/yolov5/runs/train/blocks_bins_platform4/weights/best.pt \
  -p imgsz:=416 \
  -p conf:=0.25 \
...
source ~/ros2_ws/install/setup.bash
export ROS_DOMAIN_ID=10
python3 ~/ros2_ws/src/rsdp_perception/rsdp_perception/tracks_monitor_typed_node.py
